...
{
	// Rich text formatting, for Unity UI elements that support rich text. (Thanks to git-amend for that one : https://github.com/adammyhre/Unity-Utils/blob/master/UnityUtils/Scripts/Extensions/StringExtensions.cs)
